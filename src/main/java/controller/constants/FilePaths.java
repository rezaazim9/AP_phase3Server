...
public enum FilePaths {
    ...
    SQUARANTINE_IMAGEPATH,PORTAL_IMAGEPATH, TRIGORATH_IMAGEPATH, EPSILON_IMAGEPATH, BULLET_IMAGEPATH, MENU_BACKGROUND_PATH, STATS_FILES_FOLDER_PATH,SAVE_FILES_FOLDER_PATH,
    ...
    public String getValue() {
        return switch (this) {
            ...
            case STATS_FILES_FOLDER_PATH -> "./src/main/Stats/";
        };
    }
